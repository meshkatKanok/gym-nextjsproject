        ...
        <div>
            <div className="w-[342.34px] h-[340px]  mt-[80.74px]  block lg:hidden ml-[70px]" st>
                <div className="relative">
                    <Image className="w-[209.86px] h-[340px] z-40 absolute top-[135px] left-[35.76px]" src={MobilebannerImage} />
                    <div className="absolute top-[200px]">
                        <Image className={`${global.responsiveCirlce}w-[254.41px] h-[254.41px] z-10 absolute top-[20px]`} src={responsivCilecle} />
                        <Image className="w-[230.8px] h-[266.02px] top-0 z-40" src={responsiveDew} />
                        <Image className="w-[250.31px] h-[189.34px] absolute top-[85px] left-[25px]" src={responsivevictor} />
                    </div>

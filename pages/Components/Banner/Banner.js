                    ...
                    <div className='lg:w-[1279px] lg:h-[581.94px] lg:ml-[95px]  mx-auto lg:mt-[192px] mt-[60px] w-[327px] h-[243px]'>
                        ...
                        <div className='flex items-center mt-10 lg:mt-[22px] lg:mb-[51px] mb-[40px]'>
                            <button className='lg:h-14 lg:w-[246px] w-44 h-10 bg-[#264373] flex items-center justify-around' style={{ boxShadow: '0px 20px 80px rgba(51, 78, 123, 0.3)', borderRadius: "10px" }}>
                                ...
                                <FaAngleRight className='lg:w-[26px] lg:h-[26px] w-4 h-4  bg-white rounded-3xl p-1' /></button>
                        ...
                        <span className='w-[45px] h-18px text-xs'>Brands:</span>
                        <div className='flex align-center  items-center lg:mt-[29.41px] '>
                            <Image className='lg:w-[58.81px] w-[45.32px] h-[21.25px] lg:h-[21px]' src={img1} />
                            <Image className='lg:ml-[50px] lg:w-[53.87px] lg:h-[36.37px] w-[41.5px] h-[42.09px] ml-[23.11px]' src={img2} />
                            <Image className='lg:ml-[50px] lg:w-[85px] lg:h-[63.94px] w-[61.63px] h-[31.98px] ml-[23.11px]' src={img3} />
                            <Image className='lg:ml-[50px] lg:w-[119.7px] lg:h-[39.6px] w-[92.22px] h-[23.15px] ml-[23.11px]' src={img4} />
                                ...
                                <div>
                                    ...
                                    ' style={{ boxShadow: '0px 20px 80px rgba(51, 78, 123, 0.3)' }}>
                                            ...
                                            <div className='ml-[14px]'>
                                                <span className='w-[38px] h-[28px] font-base font-bold leading-7 text-[#262524]'>150+ <br /></span>

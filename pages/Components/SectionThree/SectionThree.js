            ...
            mx-auto mt-[130px] rounded-[30px] grid lg:grid-cols-3 grid-cols-1 items-center" style={{ background: 'linear-gradient(87.05deg, #6462F0 0%, #9190E9 95.5%)' }}>
                <div className='flex items-center justify-center'>
                    <div className='relative lg:ml-[85px] ml-7'>
                        ...
                        <Image className='absolute lg:top-[25px] lg:w-[38.31px] lg:h-[50px] lg:mb-[25px] lg:ml-[30.85px] ml-[24.68px] top-5 lg:mr-[30.85px] w-[30.64px] h-[32.66px] top-5' src={group} />
                    </div>
                ...
                <div className='flex items-center justify-center'>
                    <div className='relative ml-px lg:ml-0'>
                        ...
                        <Image className='absolute lg:top-[25px] lg:w-[42.14px] lg:h-[50px] 
                        w-[33.71px] h-10
                ...
                <div className='flex items-center justify-center'>
                    <div className='relative  '>
                        ...
                        <Image className='absolute lg:top-[25px] lg:w-[38.31px] lg:h-[40.83px] lg:mb-[25px] lg:ml-[30.85px] lg:mr-[30.85px] top-5  left-[21.09px] lg:left-0' src={group2} />
                    </div>

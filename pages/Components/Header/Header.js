 ...
 function Header() {
  ...
  <button className="Gym-btn font-normal text-xl text-white mr-[5px] w-14 h-[33px]" >Gym</button>
  ...
  <div className="dropdown">
      ...
      <ul tabIndex={0} className="menu menu-compact dropdown-content  shadow bg-base-100 rounded-box rounded-box">
        <li><a>Home</a></li>
        <li><a>Program</a></li>
        <li><a>Blog</a></li>
        <li><a>About us</a></li>
